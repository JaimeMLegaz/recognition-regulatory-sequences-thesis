...
This Markdown contains the three steps of the experiment all together: obtainment of sequences, their treatment, and the training of the network. It modifies the training section of the experiment to 
...
PosSequences$X5utr <- padding_onehot(PosSequences$X5utr)
NegSequences$X5utr <- padding_onehot(NegSequences$X5utr)
...
write.csv(allGenes,file="Data/finalEvaluationAllGenes", row.names = FALSE, col.names = FALSE, quote = FALSE)
