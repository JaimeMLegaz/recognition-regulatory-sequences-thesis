...
plot(density(nchar(UTRseq$raw5utr[UTRseq$diseaseAssociation == 0])), col="blue", xlab="Lengths", ylab="# of Sequences", main="Length of sequences")
...
plot(density(nchar(UTRseq$raw5utr[UTRseq$diseaseAssociation == 0])), col="blue", xlim = c(-1,300), xlab="Lengths", ylab="# of Sequences", main="Length of sequences")
lines(density(nchar(UTRseq$raw5utr[UTRseq$diseaseAssociation == 1])), col="red")
legend("topright",legend=c("Negative sequences","Positive sequences"),
       fill=c("blue","red"),cex=0.7)
